...
export default function Loader({ text = "Loading...", fullScreen = false }: LoaderProps) {
  const content = (
    <div className="flex flex-col items-center justify-center gap-6 text-text-dim">
      <StyledWrapper>
        <svg xmlns="http://www.w3.org/2000/svg" height="150px" width="150px" viewBox="0 0 200 200" className="pencil">
          <defs>
      ...
      {text && <p className="text-sm font-medium animate-pulse text-text-secondary">{text}</p>}
    </div>
  );
...
const StyledWrapper = styled.div`
  .pencil {
    ...
    width: 8em;
    height: 8em;
    color: hsl(var(--accent)); /* This makes the drawn line match your theme's accent color! */
  }
